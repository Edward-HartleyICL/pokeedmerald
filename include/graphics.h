...
extern const u32 gMonFrontPic_Dog[];
extern const u32 gMonPalette_Dog[];
extern const u32 gMonBackPic_Dog[];
extern const u32 gMonShinyPalette_Dog[];
extern const u32 gMonStillFrontPic_Dog[];
extern const u8 gMonIcon_Dog[];
extern const u8 gMonFootprint_Dog[];
extern const u32 gMonFrontPic_DogOld[];
extern const u32 gMonPalette_DogOld[];
extern const u32 gMonBackPic_DogOld[];
extern const u32 gMonShinyPalette_DogOld[];
extern const u32 gMonStillFrontPic_DogOld[];
extern const u8 gMonIcon_DogOld[];
extern const u8 gMonFootprint_DogOld[];

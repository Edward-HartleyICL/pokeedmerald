...
const u32 gMonFrontPic_Dog[] = INCBIN_U32("graphics/pokemon/dog/anim_front.4bpp.lz");
const u32 gMonFrontPic_DogOld[] = INCBIN_U32("graphics/pokemon/dog_old/anim_front.4bpp.lz");
